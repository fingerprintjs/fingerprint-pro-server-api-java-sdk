...
dependencies {
  implementation "com.github.fingerprintjs:fingerprint-pro-server-api-java-sdk:v7.2.0"
}
```
...
- `target/fingerprint-pro-server-api-sdk-7.2.0.jar`
