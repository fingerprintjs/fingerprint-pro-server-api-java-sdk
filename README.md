...
```groovy
  ...
  dependencies {
     implementation "com.github.fingerprintjs:fingerprint-pro-server-api-java-sdk:vdev-2.0.0-3"
  }
```
...
- `target/fingerprint-pro-server-api-sdk-dev-2.0.0-3.jar`
