...
dependencies {
  implementation "com.github.fingerprintjs:fingerprint-pro-server-api-java-sdk:v7.14.0"
}
```
...
- `target/fingerprint-pro-server-api-sdk-7.14.0.jar`
...
## Documentation for Models
 ...
 - [ProductLabels](docs/ProductLabels.md)
 ...
 - [ProductRareDevice](docs/ProductRareDevice.md)
 ...
 - [WebhookRareDevice](docs/WebhookRareDevice.md)
