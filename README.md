...
<dependency>
  ...
  <version>v7.10.0-develop.1</version>
</dependency>
```
...
dependencies {
  implementation "com.github.fingerprintjs:fingerprint-pro-server-api-java-sdk:v7.10.0-develop.1"
}
```
...
- `target/fingerprint-pro-server-api-sdk-7.10.0-develop.1.jar`
