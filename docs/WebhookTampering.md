...
|**confidence** | [**ConfidenceEnum**](#ConfidenceEnum) | Confidence level of the tampering detection. If a tampering is not detected, confidence is \"high\". If it's detected, can be \"low\", \"medium\", or \"high\".  |  [optional] |
