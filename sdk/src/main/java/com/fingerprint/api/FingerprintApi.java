...
public class FingerprintApi {
  public static final String INTEGRATION_INFO = "fingerprint-pro-server-java-sdk/7.14.0";
   ...
   * @param paginationKey Deprecated pagination parameter retained for backward compatibility.  `GET /visitors/{visitor_id}` currently returns at most one visit, so pagination is not expected. Use `GET /events/search` for paginated results.  (optional)
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 403 </td><td> Forbidden. Access to this API is denied. </td><td>  -  </td></tr>
       <tr><td> 404 </td><td> Not found. The visitor ID cannot be found in this application&#39;s data. </td><td>  -  </td></tr>
       <tr><td> 429 </td><td> Too Many Requests. The request is throttled. To protect service stability during rare periods of extreme load, we may return HTTP 429 responses with message &#x60;too many search requests&#x60; even if you are within your assigned rate limits.  </td><td>  * Retry-After - Indicates how many seconds you should wait before attempting the next request. <br>  </td></tr>
       <tr><td> 504 </td><td> Gateway Timeout. Search execution exceeded the allowed timeout window. </td><td>  -  </td></tr>
     </table>
   */
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       ...
       <tr><td> 403 </td><td> Forbidden. Access to this API is denied. </td><td>  -  </td></tr>
       <tr><td> 404 </td><td> Not found. The requested visitor does not exist in this application&#39;s data. </td><td>  -  </td></tr>
       <tr><td> 429 </td><td> Too Many Requests. The request is throttled. To protect service stability during rare periods of extreme load, we may return HTTP 429 responses with message &#x60;too many search requests&#x60; even if you are within your assigned rate limits.  </td><td>  -  </td></tr>
       <tr><td> 504 </td><td> Gateway Timeout. Search execution exceeded the allowed timeout window. </td><td>  -  </td></tr>
     </table>
   */
