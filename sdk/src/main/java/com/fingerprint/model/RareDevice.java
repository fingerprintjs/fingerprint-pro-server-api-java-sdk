...
/**
 * Rare device details (present if the device is considered rare) > This Smart Signal is currently in beta and only available to select customers. If you are interested, please [contact our support team](https://fingerprint.com/support/). 
 */

@Schema(description = "Rare device details (present if the device is considered rare) > This Smart Signal is currently in beta and only available to select customers. If you are interested, please [contact our support team](https://fingerprint.com/support/). ")
@JsonPropertyOrder({
  RareDevice.JSON_PROPERTY_RESULT,
  RareDevice.JSON_PROPERTY_PERCENTILE_BUCKET
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.7.0")
public class RareDevice {
  ...
  public RareDevice result(Boolean result) {
    this.result = result;
    return this;
  }
  ...
  **/
  ...
  @Schema(description = "`true` if the device is considered rare based on its combination of hardware and software attributes. A device is classified as rare if it falls within the top 99.9 percentile (lowest-frequency segment) of observed traffic, or if its configuration has not been previously seen (`not_seen`). ")
  ...
  public RareDevice percentileBucket(PercentileBucketEnum percentileBucket) {
  ...
  **/
  ...
  /**
   * Return true if this RareDevice object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RareDevice rareDevice = (RareDevice) o;
    return Objects.equals(this.result, rareDevice.result) &&
        Objects.equals(this.percentileBucket, rareDevice.percentileBucket);
  }
