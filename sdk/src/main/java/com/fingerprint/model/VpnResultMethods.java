...
public class VpnResultMethods {
  ...
  **/
  ...
  @Schema(example = "false", required = true, description = "The browser timezone doesn't match the timezone inferred from the request IP address.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @Schema(example = "false", required = true, description = "Request IP address is owned and used by a public VPN service provider.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @Schema(example = "false", required = true, description = "This method applies to mobile devices only. Indicates the result of additional methods used to detect a VPN in mobile devices.")
  ...
  **/
  @jakarta.annotation.Nonnull
  @Schema(example = "false", required = true, description = "The browser runs on a different operating system than the operating system inferred from the  request network signature.")
