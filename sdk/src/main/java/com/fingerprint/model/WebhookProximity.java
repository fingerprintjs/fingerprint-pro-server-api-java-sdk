...
@JsonPropertyOrder({
  WebhookProximity.JSON_PROPERTY_ID,
  WebhookProximity.JSON_PROPERTY_PRECISION_RADIUS,
  WebhookProximity.JSON_PROPERTY_CONFIDENCE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.7.0")
public class WebhookProximity {
  ...
  public WebhookProximity id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public WebhookProximity precisionRadius(PrecisionRadiusEnum precisionRadius) {
  ...
  **/
  ...
  public WebhookProximity confidence(Float confidence) {
  ...
  **/
  ...
  /**
   * Return true if this WebhookProximity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookProximity webhookProximity = (WebhookProximity) o;
    return Objects.equals(this.id, webhookProximity.id) &&
        Objects.equals(this.precisionRadius, webhookProximity.precisionRadius) &&
        Objects.equals(this.confidence, webhookProximity.confidence);
  }
