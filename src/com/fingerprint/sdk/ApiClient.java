...
import com.fingerprint.sdk.auth.OAuth;

public class ApiClient {

    private String basePath = "https://api.fpjs.io";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/dev-1.0.0-1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.fpjs.io
