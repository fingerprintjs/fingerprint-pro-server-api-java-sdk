...
public class BotdError {
  ...
  **/
  ...
  @ApiModelProperty(example = "TooManyRequests", required = true, value = "Error code:  * `TooManyRequests` - the limit on secret API key requests per second has been exceeded  * `Failed` - internal server error ")
