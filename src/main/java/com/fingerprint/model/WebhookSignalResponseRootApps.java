...
public class WebhookSignalResponseRootApps {
  ...
  **/
  ...
  @ApiModelProperty(example = "false", value = "Android specific root management apps detection. There are 2 values: • `true` - Root Management Apps detected (e.g. Magisk) • `false` - No Root Management Apps detected or the client isn't Android. ")
